...
```
# 初始化环境
conda create -n blip python=3.11.11
conda activate blip
# 安装依赖
...
# test
curl -X POST -H "Content-Type: application/json" -d '{"img_urls": ["https://pro.upload.logomaker.com.cn/24/01/06/5ce553a276204a531e79b802469e263d.jpeg"]}' 'https://blip.service.domain/post'
```
